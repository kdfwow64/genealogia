...
<div>
    ...
    Genealogia Ltd, the owner and provider of this Website. Genealogia Ltd
...
<div>
    ...
    www.genealogia.co.uk/termsandconditions.
</div>
<div>
...
<div>
    Data collectively all information that you submit to Genealogia Ltd via the
...
<div>
    ...
    visit certain parts of the Website and/or when you use certain features of
    the Website. Details of the cookies used by this Website are set out in the
...
<div>
    ...
    Protection Directive) or the GDPR, and any national implementing laws,
    regulations and secondary legislation, for as long as the GDPR is effective
    in the UK;
</div>
<div>
...
<div>
    Genealogia Ltd, we or us Genealogia Ltd, a company incorporated in England
    and Wales with registered number 12734769 whose registered office is at
...
<div>
    ...
    employed by Genealogia Ltd and acting in the course of their employment or
    (ii) engaged as a consultant or otherwise providing services to Genealogia
    Ltd and accessing the Website in connection with the provision of such
    services; and
</div>
<div>
    Website the website that you are currently using, www.genealogia.co.uk, and
...
<div>
    This privacy policy applies only to the actions of Genealogia Ltd and Users
    with respect to this Website. It does not extend to any websites that can
    be accessed from this Website including, but not limited to, any links we
    may provide to social media websites.
</div>
<div>
    For purposes of the applicable Data Protection Laws, Genealogia Ltd is the
    "data controller". This means that Genealogia Ltd determines the purposes
...
<div>
    we will collect your Data automatically via cookies, in line with the
...
<div>
    We may use your Data for the above purposes if we deem it necessary to do
...
<div>
    payment details are encrypted using SSL technology (typically you will see
    a lock icon or green address bar (or both) in your browser when we use this
    technology.
</div>
<div>
    We are certified to PCI DSS. This family of standards helps us manage your
...
<div>
    ...
    this e-mail address: support@genealogia.co.uk.
</div>
<div>
...
<div>
    Right to access - the right to request (i) copies of the information we
    hold about you at any time, or (ii) that we modify, update or delete such
...
<div>
    Right to erase - the right to request that we delete or remove your Data
    from our systems.
</div>
<div>
...
<div>
    ...
    basis for processing your Data), please contact us via this e-mail address:
...
<div>
    ...
    have no control over such websites and are not responsible for the content
    of these websites. This privacy policy does not extend to your use of such
    websites. You are advised to read the privacy policy or statement of other
...
<div>
    Genealogia Ltd may, from time to time, expand or reduce our business and
    this may involve the sale and/or the transfer of control of all or part of
    Genealogia Ltd. Data provided by Users will, where it is relevant to any
    part of our business so transferred, be transferred along with that part
    and the new owner or newly controlling party will, under the terms of this
    privacy policy, be permitted to use the Data for the purposes for which it
...
<div>
    ...
    Genealogia Ltd uses Cookies to improve your experience of using the Website
    and to improve our range of services. Genealogia Ltd has carefully chosen
    these Cookies and has taken steps to ensure that your privacy is protected
...
<div>
    ...
    your consent to the placing of Cookies, you are enabling Genealogia Ltd to
    provide a better experience and service to you. You may, if you wish, deny
    consent to the placing of Cookies; however certain features of the Website
...
<div>
    ...
    and that you consult the help and guidance provided by the developer of
    your internet browser if you are unsure about adjusting your privacy
    settings.
</div>
<div>
...
<div>
    Genealogia Ltd reserves the right to change this privacy policy as we may
    ...
    following the alterations. You may contact Genealogia Ltd by email at
    support@genealogia.co.uk.
</div>
<div>
    Cookies
...
<div>
    Session cookie We use this session cookie to remember you and maintain your
